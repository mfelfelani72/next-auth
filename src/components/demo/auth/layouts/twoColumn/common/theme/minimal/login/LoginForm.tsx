    ...
    >
      <div>
        <div className="flex flex-col">
          <InputEmail
            ...
            name="email"
            label={
              <div className="xs:text-[16px] text-amber-800 font-medium">
                {t("email")}
              </div>
            }
          ...
          <InputPassword
            ...
            name="password"
            label={
              <div className="mt-6 xs:text-[16px] text-amber-800 font-medium">
                {t("password")}
              </div>
            }
        ...
        <div className="flex justify-end mt-2">
          <LocalizedLink
            ...
            className="text-xs text-amber-700/70 hover:text-amber-900 transition-colors font-medium"
          >
            {t("forgot_password")}
          </LocalizedLink>
        </div>
      ...
      <div>
        ...
        <div className="flex gap-3 mt-2">
          <button
            type="button"
            className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg border border-amber-200/60 bg-amber-50/60 hover:bg-amber-100/60 hover:border-amber-300 transition-all duration-300 text-amber-800 cursor-pointer shadow-sm hover:shadow-md"
          >
            <GoogleIcon />
